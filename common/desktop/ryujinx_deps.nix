...
{ fetchNuGet }: [
  ...
  (fetchNuGet { pname = "Avalonia.Markup.Xaml.Loader"; version = "11.1.4"; hash = "sha256-PnWcTjFUbbb5CnEu09K5se3Nyf9GGkwzUXS/YNmknXc="; })
  ...
  (fetchNuGet { pname = "Avalonia.Svg"; version = "11.1.0.1"; hash = "sha256-CirdAKFy0OzEhQ9bMBGDHYLDh8ht+BqL8c/ybxppdYc="; })
  ...
  (fetchNuGet { pname = "FluentAvaloniaUI"; version = "2.1.0"; hash = "sha256-D3KEq88+6kmODqJv+Yk7FFIxQVrsfn7m1o34v8i79rA="; })
